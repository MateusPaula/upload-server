...
describe('export uploads', () => {
  it('should be able to export uploads', async () => {
    ...
    // Get first call from stub and first parameter (input)
    ...
    // Array of headers and data, separate by comma
    ...
    expect(csvAsArray).toEqual([
      ...
      // The date format is a little bit different of a .toISOString(), that's why we're using a expect.any
